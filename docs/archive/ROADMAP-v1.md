# LLM Inference Engine — Development Roadmap (v1 — ARCHIVED)

> **Archived 2026-08-07 (M3-T01).** This is the original multi-GPU CUDA plan,
> superseded by the CPU-first pivot (ADR-004). The current roadmap is
> `ROADMAP.md` at the repository root. Kept unmodified as project history and
> as the reference plan should a GPU backend ever be revived.
